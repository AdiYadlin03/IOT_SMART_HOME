# intended to manage the MG car system
# insert data to MG smart car DB
...
def insert_DB(topic, m_decode):
    ...
    # Elec Meter case:
        ...
        da.add_IOT_data('Sensitivity', da.timestamp(), m_decode.split(' Water: ')[1])
...
def check_DB_for_change(client):
    ...
    if float(df.value[len(df.value)-1]) > Sensitivity_max:
